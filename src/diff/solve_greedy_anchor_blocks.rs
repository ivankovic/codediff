...
/// module doc comment) does the heavy lifting of rejecting structurally-unrelated pairs; not yet
/// swept against `benchmark_optimal_solutions` the way `solve_bottom_up_expansion::DICE_THRESHOLD`
/// was - see that module's doc comment for the sweep methodology this should get before being
/// trusted as tuned.
const MAX_COST_RATIO: f64 = 0.5;
