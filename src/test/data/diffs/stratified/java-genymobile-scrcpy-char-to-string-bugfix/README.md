...
- **Repository:** https://github.com/Genymobile/scrcpy.git (`Genymobile-scrcpy.git`)
- **Commit:** `ebecbe6bc66f6d2c5d7fb18fe37641fdacb0a8df`
- **File:** `server/src/main/java/com/genymobile/scrcpy/InvalidEncoderException.java`
...
- `LICENSE` - Apache License 2.0 (https://github.com/Genymobile/scrcpy/blob/ebecbe6bc66f6d2c5d7fb18fe37641fdacb0a8df/LICENSE)
