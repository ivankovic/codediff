...
- **Repository:** https://github.com/nextcloud/ios.git (`nextcloud-ios.git`)
- **Commit:** `bf284ac5bb885ece12934dde3bfbee45ea2ff5db`
- **File:** `iOSClient/Networking/NCNetworking+NextcloudKitDelegate.swift`
...
- `COPYING.iOS` - Unrecognized license text (see linked file) (https://github.com/nextcloud/ios/blob/bf284ac5bb885ece12934dde3bfbee45ea2ff5db/COPYING.iOS)
- `LICENSE.txt` - GNU General Public License v3.0 (https://github.com/nextcloud/ios/blob/bf284ac5bb885ece12934dde3bfbee45ea2ff5db/LICENSE.txt)
