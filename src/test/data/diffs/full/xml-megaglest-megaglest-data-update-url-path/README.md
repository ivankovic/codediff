...
- **Repository:** https://github.com/MegaGlest/megaglest-data (`MegaGlest-megaglest-data`)
- **Commit:** `4511c2b2455d5e79d0a0ebbde4885086fd44df40`
- **File:** `techs/megapack/factions/indian/units/main_teepee/main_teepee.xml`
...
No LICENSE/COPYING/NOTICE file was found at the repository root at this commit. Licensing terms are unknown from this checkout alone - check the repository above directly before reusing this sample outside codediff's own test suite.
