...
- **Repository:** https://github.com/PixarAnimationStudios/OpenSubdiv (`PixarAnimationStudios-OpenSubdiv`)
- **Commit:** `17530d964d082f9f59fd1b429c5501bb61178329`
- **File:** `regression/common/far_utils.h`
...
### `LICENSE.txt` - Unrecognized license text (see full text below)
...
### `NOTICE.txt` - Unrecognized license text (see full text below)
