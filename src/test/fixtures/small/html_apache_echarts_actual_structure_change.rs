...
#[test]
fn mapping() -> Result<()> {
    // 2026-09-03: tightened 76,54 -> 13,9. The limit was stale rather than a deliberate allowance:
...
fn invariants() -> Result<()> {
    assert_ground_truth_invariants("html-apache-echarts-actual-structure-change")
}
