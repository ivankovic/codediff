...
fn mapping() -> Result<()> {
    ...
    // Re-measured 2026-09-08 and tightened 229,155 -> 228,154: the delimiter fix in 974cc062
...
fn invariants() -> Result<()> {
    assert_ground_truth_invariants("tsx-excalidraw-excalidraw-huge-file-with-real-logic-change")
}
