...
fn mapping() -> Result<()> {
    ...
    // 2026-09-03: tightened 47,33 -> 42,30. The limit was stale rather than a deliberate allowance:
...
fn invariants() -> Result<()> {
    assert_ground_truth_invariants("rust-rustdesk-rustdesk-large-file-40k-normal-feature-work")
}
