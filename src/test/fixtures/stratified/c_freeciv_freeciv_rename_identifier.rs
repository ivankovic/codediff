...
#[test]
fn mapping() -> Result<()> {
    test::helper::human_mapping::assert_matches_human_mapping("c-freeciv-freeciv-rename-identifier")
}

#[test]
fn painting() -> Result<()> {
    // measured 2026-09-11: minimal 0.010%, full 0.010%
    ...
    assert_matches_human_painting_within_limit("c-freeciv-freeciv-rename-identifier", 0.02)
}

#[test]
fn invariants() -> Result<()> {
    assert_ground_truth_invariants("c-freeciv-freeciv-rename-identifier")
}
