...
fn mapping() -> Result<()> {
    ...
    // 2026-09-03: tightened 5,5 -> 4,4. The limit was stale rather than a deliberate allowance: it
    ...
    test::helper::human_mapping::assert_matches_human_mapping_within_limit(
        "scala-com-lihaoyi-mill-small-change",
        4,
        4,
    )
}
...
fn invariants() -> Result<()> {
    assert_ground_truth_invariants("scala-com-lihaoyi-mill-small-change")
}
