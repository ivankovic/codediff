...
#[test]
fn mapping() -> Result<()> {
    // 2026-09-03: tightened 11,9 -> 1,1. The limit was stale rather than a deliberate allowance: it
...
fn invariants() -> Result<()> {
    assert_ground_truth_invariants("scala-com-lihaoyi-mill-split-import")
}
