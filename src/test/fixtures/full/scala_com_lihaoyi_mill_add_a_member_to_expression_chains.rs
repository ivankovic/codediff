...
fn mapping() -> Result<()> {
    ...
    // 2026-09-03: tightened 9,2 -> 3,2. The limit was stale rather than a deliberate allowance: it
    ...
    test::helper::human_mapping::assert_matches_human_mapping_within_limit(
        "scala-com-lihaoyi-mill-add-a-member-to-expression-chains",
        3,
        2,
    )
}
...
fn invariants() -> Result<()> {
    assert_ground_truth_invariants("scala-com-lihaoyi-mill-add-a-member-to-expression-chains")
}
