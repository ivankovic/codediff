...
#[test]
fn mapping() -> Result<()> {
    // 2026-09-03: tightened 2,0 -> 1,0. The limit was stale rather than a deliberate allowance: it
...
fn invariants() -> Result<()> {
    assert_ground_truth_invariants("php-symfony-finder-move-elseif-block-to-else")
}
