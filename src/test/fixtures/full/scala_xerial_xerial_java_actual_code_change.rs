...
fn mapping() -> Result<()> {
    ...
    // 2026-09-03: tightened 11,10 -> 4,3. The limit was stale rather than a deliberate allowance:
    ...
    test::helper::human_mapping::assert_matches_human_mapping_within_limit(
        "scala-xerial-xerial-java-actual-code-change",
        4,
        3,
    )
}
...
fn invariants() -> Result<()> {
    assert_ground_truth_invariants("scala-xerial-xerial-java-actual-code-change")
}
