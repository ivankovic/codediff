...
# Measured 2026-09-07. The corpus directory holds 651 fixtures; 650 of them carry a
# human_mapping.json and are what every accuracy number in the paper is scored against. The 651st
...
#
# NumFixtures is therefore the ground-truth-bearing count, 650, which is the denominator of every
# per-tool row, the ablation study, and the node accuracy below.
#
# Refreshed together, from one corpus state, on 2026-09-07 (previously, the same day, 627 and 615;
...
CORPUS = {
    "NumFixtures": 650,
    "NodesMatched": 5_733_190,
    "NodesTotal": 5_740_630,
    # Distinct languages across the fixture corpus, from `analyze_human_mappings`' own "By
    # language" census (24 as of 2026-09-07, unchanged since 2026-09-02 - the 138 fixtures added
...
CORPUS_VISIBLE = {
    "VisibleNodesMatched": 3_917_686,
    "VisibleNodesTotal": 3_922_773,
}
