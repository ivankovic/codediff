...
def read_generated_block(fragment_path, previous_output_path, expected_macros, refresh_hint):
    ...
    full corpus; measure-rq1 is a multi-hour timing run) and are deliberately *not* prerequisites of the
...
def build(
    ...
    out += [
        ...
        "% `make rq1-report` (fast, existing data) or `make measure-rq1` (full re-measurement).",
    ]
...
def main():
    ...
    measure-rq1, rq1_source = read_generated_block(
