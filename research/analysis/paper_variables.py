...
def build(empirical_lines, rq1_lines, comparison_lines, ambiguity_lines, shape_lines):
...
def main():
    ...
    # ambiguity_report.py actually measured) are two names for the corpus size. They agree today
    # and the paper quotes both; a refresh that moves one and not the other would print two
    ...
    print(
        ...
        f"shape block from: {shapes_source})"
    )
