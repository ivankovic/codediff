...
def write_paper_variables(
    ...
    ast_percentiles,
    correlation,
    output_path="plots/variables.tex",
):
    """
    Writes research/papers/introductory-paper's empirical-study numbers as LaTeX `\\newcommand`
    macros, so that paper's main.tex can `\\input` this file instead of hand-transcribing numbers.
...
if __name__ == "__main__":
    ...
    # write_paper_variables's own doc comment for why this exists.
